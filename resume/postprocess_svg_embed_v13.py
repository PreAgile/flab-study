...
SRC_DOCX = ROOT / "resume_v13.docx"
OUT_DOCX = ROOT / "resume_v13.docx"  # overwrite
...
PNG_TO_SVG = {
    ...
    "image4.png": "B2_hierarchical_concurrency.svg",
    "image5.png": "B3_dashboard_2step_query.svg",
    "image6.png": "C1_session_lock_registry.svg",
    "image7.png": "C2_proxy_pool_before_after.svg",
    "image8.png": "C3_akamai_bypass_state_machine.svg",
    "image9.png": "C4_single_flight_hexagonal.svg",
    "image10.png": "D1_auto_reply_pipeline.svg",
}
