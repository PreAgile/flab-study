...
MD_PATH = os.path.join(ROOT, "resume_v17.md")
OUT_PATH = os.path.join(ROOT, "resume_v17.docx")
...
def add_image(doc, png_path, width_cm=17.5, caption=None):
    p = doc.add_paragraph()
    ...
    while i < len(lines):
        ...
        if m:
            ...
            if os.path.exists(png_path):
                add_image(doc, png_path, width_cm=17.5, caption=alt)
            else:
