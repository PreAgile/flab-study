...
SRC_DOCX = ROOT / "resume_v14.docx"
OUT_DOCX = ROOT / "resume_v14.docx"  # overwrite
...
PNG_TO_SVG = {
    ...
    "image3.png": "A3_payment_reconciliation.svg",
    "image4.png": "A4_coupon_idempotent.svg",
    "image5.png": "B4_bulk_register_pessimistic_lock.svg",
    "image6.png": "B1_rds_queue_cas.svg",
    "image7.png": "B2_hierarchical_concurrency.svg",
    "image8.png": "B5_active_active_deploy.svg",
    "image9.png": "B3_dashboard_2step_query.svg",
    "image10.png": "C1_session_lock_registry.svg",
    "image11.png": "C2_proxy_pool_before_after.svg",
    "image12.png": "C3_akamai_bypass_state_machine.svg",
    "image13.png": "C4_single_flight_hexagonal.svg",
    "image14.png": "D1_auto_reply_pipeline.svg",
}
